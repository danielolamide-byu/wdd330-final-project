        ...
        .then(data => {
            ...
            if (data.meals) {
                data.meals.forEach(meal => {
                    ...
                    webLink.href = `${meal.strSource}`
                    webLink.textContent = `Click here for more information.` 
                    category.textContent = `Category: ${meal.strCategory}` 
                    area.textContent = `Meal's Reqion: ${meal.strArea}` 
                    dateModified.textContent = `${meal.dateModified}`

                    instructionDiv.classList.add('area');
                    youTubeLink.classList.add('link');
                    h1.classList.add('areas');
                    section.classList.add('main');
                    img.classList.add('foodImg');
                    img.classList.add('fade-in');
                    category.classList.add('areas');
                    area.classList.add('areas');
                    webLink.classList.add('link');
                    dateModified.classList.add('link');
                    ...
                    section.appendChild(webLink);
                    section.appendChild(dateModified);
                    // section.appendChild(category);
